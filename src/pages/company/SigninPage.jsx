...
const loginSchema = z.object({
  ...
  authKey: z
    .string()
    .min(6, "Authentication Key must be at least 6 characters"),
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">
                CarbonSetu Admin Portal
              </h1>
              <p className="text-sm text-gray-500">NCCI, MOES, Govt of India</p>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-gray-600 leading-relaxed max-w-md mx-auto lg:mx-0">
                  Access the CarbonSetu administrative dashboard with your
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 mt-2">
                      Enter your government Credentials
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                      <Label htmlFor="auth-key" className="text-gray-700">
                        Authentication Key
                      </Label>
                      <Input
                        id="auth-key"
